//Run for an hour.
//Start the python interpreter only once.
//run py_GCcollect every 30 secods.
...
for(i=0;i<120;i++){
  ...
  //Run garbage collection code every 30 seconds.
  sleep(30);
  ...
  printf("\n");
  printf("\n");
  printf("The memory being used now at the END OF PROCESS is: \n");
  print_memory();
